...
const RichTextEditor = ({ content, onContentChange }: RichTextEditorProps) => {
    const editor = useEditor({
        ...
        content: content || '<h1">Write your post here...</h1>',
        onUpdate: ({ editor }) => {
    ...
    return (
        <div>
            ...
            <div className="w-screen md:w-[48rem] mx-auto p-2">
                <EditorContent editor={editor} className="min-h-[200px] bg-white p-4 border rounded" />
            </div>
        </div>
    )
}
...
//     const [content, setContent] = useState('') // this
//     const editor = useEditor({
//         extensions: [
//             StarterKit,
//             TextAlign.configure({
...
//         ],
//         immediatelyRender: false,
//         content: '<h1">Write your post here...</h1>',
//         onUpdate: ({ editor }) => {
...
//       function getFirstTagText(htmlString: string) { // this
...
//     const handleLogContent = () => { // this
//         if (!editor) return
//         console.log('HTML:', editor.getHTML())
//         console.log('First tags content:', getFirstTagText(editor.getHTML()))
//     }
